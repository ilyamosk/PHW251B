...
There's 6779 unique values in the `id` field, when there's 10000 observations in the total dataset! This could mean several things -- that perhaps each observation *is* unique but needs another identifying variable (say, for example, `survey_yr`) in combination. 
