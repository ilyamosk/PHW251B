...
This is the perfect segway into the `here` package. `here` provides you with a safe starting point for paths - the **project root**. This means that you can open up your project on `DataHub` or any other machine and all filepaths are going to be contained (Instead of fragile absolute paths or setwd(), you write)
...
data = readr::read_csv(here::here("week_1", "data", "asthma.csv"))
```
...
knitr::include_graphics(here::here(week, "images", "01_yaml.png"))
```
